...
/** NoAudioCodecSimplex with MAX98357A SD (Shutdown) pin control.
 * SD LOW = mute, SD HIGH = unmute. Controls SD pin when EnableOutput is called. */
class NoAudioCodecSimplexWithSD : public NoAudioCodecSimplex {
public:
    NoAudioCodecSimplexWithSD(int input_sample_rate, int output_sample_rate, gpio_num_t spk_bclk,
                             gpio_num_t spk_ws, gpio_num_t spk_dout, gpio_num_t spk_sd_pin,
